...
grep -Fq '"homeOpsRelease": "COMPLETED"' "$evidence_dir/homeops-integration-evidence.json"
grep -Fq '"homeOpsApplicationDeploy": "COMPLETED"' "$evidence_dir/homeops-integration-evidence.json"
grep -Fq '"v14ProductionMigration": "APPLIED"' "$evidence_dir/homeops-integration-evidence.json"
grep -Fq '"agentArtifact": "PUBLISHED"' "$evidence_dir/homeops-integration-evidence.json"
grep -Fq '"agentRollout": "NOT_RUN"' "$evidence_dir/homeops-integration-evidence.json"
...
grep -Fq '"productionPinDriftRejected": true' "$evidence_dir/homeops-integration-evidence.json"
grep -Fq '"policyDriftRejected": true' "$evidence_dir/homeops-integration-evidence.json"
grep -Fq '"activationStateDriftRejected": true' "$evidence_dir/homeops-integration-evidence.json"
grep -Fq '"readinessDriftRejected": true' "$evidence_dir/homeops-integration-evidence.json"
