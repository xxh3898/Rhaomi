...
- 매장정보·갤러리·미디어·견종·서비스 dashboard navigation과 same-page 관리 홈 복귀 component test
...
현재 `/admin/` 인증 셸과 미디어·매장정보·견종·서비스·갤러리 관리 UI는 실제 iPhone Safari·VoiceOver에서 아직 검증하지 않았다. 사진 보관함의 HEIC 선택·upload·preview, shop time/radio/url form과 picker, 견종·서비스·갤러리 form의 keyboard·reflow, relation picker·datetime-local·session cookie와 archive/restore를 실제 기기에서 확인하고 2FA·TLS gate를 충족한 뒤 운영에 사용한다.
