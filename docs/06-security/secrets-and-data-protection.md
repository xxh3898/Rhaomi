...
- TLS/DNS credential
- WebAuthn/passkey credential과 recovery code
...
- 실제 운영 계정은 별도 Secret·WebAuthn/passkey·recovery code 승인 뒤 생성
...
| WebAuthn/passkey credential·recovery code | 기기 분실·사용·노출 또는 운영자 변경 |
