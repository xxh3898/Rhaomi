...
- exact `BuildSnapshotV1` top-level·entity key와 UUID·slug·microsecond Instant·URL·text/number limit, uniqueness, relation, published/time eligibility와 exact media manifest를 fail-closed로 다시 검증한다.
