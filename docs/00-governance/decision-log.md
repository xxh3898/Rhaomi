...
| ADR-010 | Production은 Cloudflare Tunnel·계층형 Nginx와 수동 digest release를 사용한다. | 승인 | [ADR-010](../09-decisions/ADR-010-production-topology-and-code-release.md) |
...
| ADR-012 | PostgreSQL·private media를 application-consistent encrypted restic backup set으로 보호한다. | 승인 | [ADR-012](../09-decisions/ADR-012-application-consistent-backup-restore.md) |
